...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    // Verificação de Segurança: Protege o Dashboard
  ...
  return (
    <div className="h-screen overflow-hidden bg-premium-50 flex flex-col md:flex-row font-sans text-premium-900">
      ...
      <aside className="w-full md:w-64 bg-premium-900 text-white flex flex-col shadow-2xl z-20 shrink-0">
        <div className="p-6 flex items-center justify-center border-b border-premium-800 shrink-0 h-24"><img src="/logo.png?v=2" alt="Laguerre Beauty" className="h-16 w-auto object-contain" /></div>
