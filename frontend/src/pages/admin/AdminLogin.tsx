...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Credenciais atualizadas para Laguerre Beauty
    if (email === 'contato@laguerrebeauty.com.br' && password === 'LaguerreAdmin@2024!') {
    ...
    <div className="min-h-screen bg-premium-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white p-8 rounded-sm shadow-xl border border-premium-100">
        <div className="flex flex-col items-center mb-8">
          {/* Logo da Laguerre no Login Admin */}
          <div className="mb-6">
          ...
          <p className="text-sm text-premium-500 mt-1">Painel Administrativo Diversatte</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="contato@laguerrebeauty.com.br"
              required
            />          </div>
          <div>
